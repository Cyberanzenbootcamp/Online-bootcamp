...
# 1. Retrieve the latest key and drop it into trusted.gpg.d
...
RUN curl -sL https://archive.kali.org/archive-keyring.gpg -o /etc/apt/trusted.gpg.d/kali-archive-keyring.gpg && \
